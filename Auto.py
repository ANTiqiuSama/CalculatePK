...
WAIT_DURATION = 0.6 # Fastest 0.6s, Safe 1.2s
...
def main():
    ...
    question_region = (window_x + QUESTION_REGION_OFFSET_X, window_y + QUESTION_REGION_OFFSET_Y, QUESTION_REGION_WIDTH,
                       QUESTION_REGION_HEIGHT)
